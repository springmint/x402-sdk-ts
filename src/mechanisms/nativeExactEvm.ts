/**
 * ExactEvmClientMechanism - EVM client mechanism for "transfer_auth" payment scheme
 *
...
import { getChainId, EvmAddressConverter, SCHEMES } from "../index.js";
...
/**
 * EVM client mechanism for "transfer_auth" payment scheme
 */
